...
RSpec.describe 'Renders the post show page', type: :feature do
  before :each do
    @user = User.create(name: 'Captain burns', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'I am a software developer.', post_counter: 9)
    @first_post = Post.create(title: 'Hello', text: 'Captain of the fifth', comments_counter: 0, likes_counter: 0, user_id: @user.id)
    5.times do |_i|
